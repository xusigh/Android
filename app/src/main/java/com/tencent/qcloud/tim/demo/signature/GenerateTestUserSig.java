...
public class GenerateTestUserSig {
    ...
    private static final String PRIVATEKEY = "-----BEGIN PRIVATE KEY-----\n" +
            "MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQg78f3duBSsBupTeBw\n" +
            "veSfynGj/KT7DMIs2tvZesGIvVihRANCAASeE5iRfqq1SVe33XecldyYkFyQMCf+\n" +
            "n7xCzTi87bsutpf2ElxTzphYCJzB4gqzvBCxz+Shy8B5xcJj2ufVVCQe\n" +
            "-----END PRIVATE KEY-----\n";
